        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Import Data Alumni</li>
                </ol>
            </section>
                ...
                <div class="row">
                        ...
                        <div class="box">
                            ...
                            <div class="box">
                                ...
                                <center>
                                    ...
                                    <form method="post" action="<?php echo base_url("admin/Alumni/form"); ?>" enctype="multipart/form-data">
                                        <!--
                  ...
                  -->
                                    ...
                                    if (isset($_POST['preview'])) { // Jika user menekan tombol Preview pada form
                                        ...
                                        echo "<form method='post' action='" . base_url('admin/Alumni/import') . "'>";
                  ...
                  <tr>
                    ...
                    <th>KONTAK</th>
                                    ...
                                    <?php
                                            ...
                                            echo "<a href='" . base_url("admin/alumni") . "' class='btn btn-danger'>Cancel</a>";
                                        }
