...
<head>
	...
	<meta property="og:site_name" content="faizm.com" />
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<h4>Share:</h4>
						<div>
							<a class="popup2 btn btn-info btn-sm" href="https://whatsapp://send?text=<?php echo site_url() . 'blog/Detail' ?>" title="Bagikan ke WhatsApp"><i class="fa fa-whatsapp"></i> WhatsApp</a>
