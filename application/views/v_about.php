		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Faiz Maruf adalah seorang senior engineer lulusan perguruan tinggi di daerah Sumatera Barat.</p>
						<ul class="fh5co-social">
							...
							<li><a href="#"><i class="icon-linkedin" style="color : #000000"></i></a></li>
						</ul>
					</div>
					<div class="col-md-4 fh5co-staff">
				...
				<?php	foreach ($data->result() as $row) :	?>    
					  ...
					  <div class="avatar mx-auto">
						...
						<p><?= $row->bph_nama; ?> adalah seorang web designer lulusan perguruan tinggi di daerah Sumatera Barat.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
