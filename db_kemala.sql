...
CREATE TABLE `tbl_alumni` (
  ...
  `alumni_nama` varchar(50) NOT NULL,
  `alumni_angkatan` varchar(4) NOT NULL,
  `alumni_fakultas` varchar(30) NOT NULL,
  `alumni_nohp` varchar(20) NOT NULL
...
INSERT INTO `tbl_alumni` (`alumni_id`, `alumni_nama`, `alumni_angkatan`, `alumni_fakultas`, `alumni_nohp`) VALUES
(1, 'ragil', '2012', 'FP', '08984153100');
...
CREATE TABLE `tbl_anggota` (
  ...
  `anggota_angkatan` varchar(4) NOT NULL,
  `anggota_fakultas` varchar(30) DEFAULT NULL,
  `anggota_nohp` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `tbl_bph`
--

CREATE TABLE `tbl_bph` (
...
CREATE TABLE `tbl_coverpage` (
  ...
  `coverpage_judul` varchar(100) NOT NULL,
  `coverpage_tanggal` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `coverpage_gambar` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Biografiii', '2016-09-06 05:49:04'),
...
(13, 'faiz', NULL, 'L', 'faiz', 'c4ca4238a0b923820dcc509a6f75849b', NULL, 'faiz@gmail.com', '08984153117', NULL, NULL, NULL, NULL, 1, '1', '2020-07-20 15:20:17', '0b5e10f5877ea7654a0506ba059e3f15.png');
...
(946, '2019-12-25 14:56:54', '::1', 'Chrome'),
(947, '2020-01-03 04:24:19', '::1', 'Chrome'),
(948, '2020-01-14 03:53:32', '::1', 'Chrome'),
(949, '2020-01-23 12:19:04', '::1', 'Chrome'),
(950, '2020-01-24 08:46:56', '::1', 'Spartan'),
(951, '2020-02-01 02:56:51', '::1', 'Chrome'),
(952, '2020-02-06 12:31:42', '::1', 'Chrome'),
(953, '2020-02-06 17:33:47', '::1', 'Chrome'),
(954, '2020-02-08 06:51:30', '::1', 'Chrome'),
(955, '2020-02-09 06:44:32', '::1', 'Chrome'),
(956, '2020-02-10 04:21:01', '::1', 'Chrome'),
(957, '2020-02-14 00:34:09', '::1', 'Chrome'),
(958, '2020-02-15 11:57:28', '::1', 'Chrome'),
(959, '2020-02-24 15:22:36', '::1', 'Chrome'),
(960, '2020-02-28 02:05:34', '::1', 'Chrome'),
(961, '2020-02-29 02:36:11', '::1', 'Chrome'),
(962, '2020-03-01 09:41:45', '::1', 'Chrome'),
(963, '2020-03-03 01:47:48', '::1', 'Chrome'),
(964, '2020-03-04 10:15:17', '::1', 'Chrome'),
(965, '2020-03-06 04:38:20', '::1', 'Chrome'),
(966, '2020-03-07 02:18:36', '::1', 'Chrome'),
(967, '2020-03-10 12:09:34', '::1', 'Chrome'),
(968, '2020-03-11 03:38:07', '::1', 'Chrome'),
(969, '2020-03-12 17:16:41', '::1', 'Chrome'),
(970, '2020-03-13 17:06:38', '::1', 'Chrome'),
(971, '2020-03-16 04:12:30', '::1', 'Chrome'),
(972, '2020-03-16 23:22:09', '::1', 'Chrome'),
(973, '2020-04-03 04:08:51', '::1', 'Chrome'),
(974, '2020-04-05 11:58:15', '::1', 'Chrome'),
(975, '2020-04-20 07:19:18', '::1', 'Chrome'),
(976, '2020-05-31 14:50:04', '::1', 'Chrome'),
(977, '2020-06-02 05:36:53', '::1', 'Chrome'),
(978, '2020-06-03 08:12:08', '::1', 'Chrome'),
(979, '2020-06-04 04:18:49', '::1', 'Chrome'),
(980, '2020-06-06 22:59:28', '::1', 'Chrome'),
(981, '2020-06-10 07:30:18', '::1', 'Chrome'),
(982, '2020-06-11 22:32:31', '::1', 'Chrome'),
(983, '2020-06-14 02:20:45', '::1', 'Chrome'),
(984, '2020-06-15 11:25:01', '::1', 'Chrome'),
(985, '2020-07-06 12:00:28', '::1', 'Chrome'),
...
(55, '2020-02-14 00:39:30', '::1', 31),
(56, '2020-02-14 00:39:32', '::1', 0),
(57, '2020-02-14 00:41:31', '::1', 29),
(58, '2020-02-14 01:03:52', '::1', 30),
(59, '2020-02-14 01:04:00', '::1', 32),
(60, '2020-02-14 13:43:02', '::1', 33),
(61, '2020-02-24 15:56:48', '::1', 34),
(62, '2020-02-24 15:56:48', '::1', 0),
(63, '2020-02-29 02:40:13', '::1', 31),
(64, '2020-02-29 02:40:13', '::1', 0),
(65, '2020-02-29 04:06:53', '::1', 36),
(66, '2020-03-03 04:21:56', '::1', 36),
(67, '2020-03-03 04:21:57', '::1', 0),
(68, '2020-03-07 02:21:45', '::1', 37),
(69, '2020-03-07 02:21:45', '::1', 0),
(70, '2020-03-07 02:21:56', '::1', 36),
(71, '2020-03-11 03:38:16', '::1', 36),
(72, '2020-03-11 03:38:17', '::1', 0),
(73, '2020-03-14 00:03:21', '::1', 36),
(74, '2020-03-14 00:03:22', '::1', 0),
(75, '2020-03-14 00:03:28', '::1', 29),
(76, '2020-04-03 04:11:29', '::1', 38),
(77, '2020-04-03 04:11:30', '::1', 0),
(78, '2020-06-02 05:55:40', '::1', 34),
(79, '2020-06-02 05:55:41', '::1', 0),
(80, '2020-06-06 23:04:53', '::1', 37),
(81, '2020-06-06 23:04:53', '::1', 0),
(82, '2020-06-06 23:06:00', '::1', 36),
(83, '2020-06-06 23:07:03', '::1', 34),
(84, '2020-06-10 08:51:17', '::1', 38),
(85, '2020-06-10 08:51:17', '::1', 0),
(86, '2020-06-11 23:11:06', '::1', 37),
(87, '2020-06-11 23:11:06', '::1', 0),
...
--
ALTER TABLE `tbl_alumni`
  MODIFY `alumni_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
